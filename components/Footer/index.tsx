...
const copyrightText = `© ${currentYear} Stops Car Wash. All rights reserved.`;
const Footer = () => {
  return (
    <>
            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-10 mt-5">
                  Stops Car Wash is dedicated to providing top-quality,
                  eco-friendly car wash services tailored to meet the needs of
                  every vehicle. Our commitment to excellence ensures a
                  pristine, polished finish for your car every time.{" "}
                </p>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-5">
                ...
                <li>
                  <a href="https://x.com/stopswash" aria-label="social icon">
                    <svg
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/company/stopwash/mycompany/"
