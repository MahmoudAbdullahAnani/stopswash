          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join Us Today & Experience Superior Car Wash Services
              </h2>
              <p>
                Become a part of Stops Car Wash today and enjoy top-tier car
                wash services designed to meet all your vehicle's needs.
                Experience the difference with our eco-friendly methods, premium
                detailing, and state-of-the-art technology.{" "}
              </p>
            </motion.div>
            <motion.div
              variants={{
